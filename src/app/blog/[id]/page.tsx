                ...
                <div className='flex flex-col gap-4 justify-center mb-[50px]'>
                   <Image src={filterd?.image || "/fallback-image.jpg"} alt='blogs' width={400} height={400} className='lg:w-[600px] lg:h-[450px] w-[300px] h-[250px]'/>
                    ...
                    <div className='border-[1px] lg:h-[40px] h-[55px] lg:mt-0 mt-[40px] lg:flex justify-between p-2 text-[13px] '>
                      ...
                      <h1 className='flex gap-3 text-gray-700'>Share: <a className="text-xl" href="https://www.linkedin.com/in/ubaid-ali098?utm_source=share&utm_campaign=share_via&utm_content=profile&utm_medium=ios_app" > <FaLinkedin /></a>
                                <a className="text-xl" href="https://github.com/ubaidalishaikh"><IoLogoGithub  /></a>
                                <a className="text-xl" href="https://www.instagram.com/ig_ubaid_ali?igsh=OTYxb3RrN3piY3cy&utm_source=qr">< FaInstagram/></a></h1>
                    </div>
                    <CommentSection/>
                </div>
      </div>
