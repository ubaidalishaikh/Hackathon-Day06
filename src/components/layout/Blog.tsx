...
//         <h1 className='text-center text-bordercoloryello font-greatVibes text-[32px] leading-[40px] font-medium'>Blog Post</h1>
//         <h1 className='text-center font-helvetica font-bold text-[40px] leading-[45px] text-whitetext'><span className='text-bordercoloryello'>La</span>test News & Blog</h1>
//       <section className="text-gray-600 flex flex-col px-[230px]">
//   <div className="container  py-24 ">
//     <div className="flex flex-wrap -m-4">
//       <div className="p-4 w-[300px] h-[379px]">
...
//           />
//           <div className="p-6">
//             <h2 className="text-bordercoloryello title-font font-medium text-[16px] mb-1">
//               10 February 2022 
//             </h2>
           
//             <p className="font-helvetica font-bold text-[14px] leading-[17px] text-whitetext">
//             Pellentesque Non Efficitur Mi Aliquam Convallis Mi Quis
//             </p>
//           </div>
//           <div className='px-[30px] flex justify-between'>
//             <div className='text-[13px] font-medium leading-[24px] text-whitetext'>Learn More</div>
//             <div className='flex gap-[10px] text-whitetext text-[18px]'>
//                 <MdThumbUpOffAlt className="text-whitetext hover:text-bordercoloryello cursore-pointer"/> <LiaCommentDotsSolid className="text-whitetext hover:text-bordercoloryello cursore-pointer"/> <LuShare2 className="text-whitetext hover:text-bordercoloryello cursore-pointer"/>
//             </div>
//           </div>
//         </div>
//       </div>
