...
const ProductCards: React.FC = () => {
    ...
    function turncateDescription(description: string): string {
        ...
        <div className="p-4">
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 lg:grid-cols-4 gap-6">
                {products.map((product) => (
                    <div
                        key={product._id}
                        className="g-white shadow-md rounded-l gap-4 hover:shadow-lg transition-shadow duration-300">
                        ...
                        <div className="mt-4">
                            ...
                            <p text-slate-800 mt-2 text-sm>{turncateDescription(product.description)}</p>
